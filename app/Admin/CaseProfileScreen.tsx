...
export default function CaseProfileScreen({ navigation, route }: Props) {
  ...
  const handleEscalate = async () => {
    try {
      ...
      Alert.alert('⬆ Escalated', 'Case has been escalated to the department head.');
    } catch (err: any) {
      Alert.alert('Error', err.message);
    }
  };
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerBadges}>
            <View
              style={[
                styles.badge,
                { backgroundColor: statusColor + '20', borderColor: statusColor, borderWidth: 1 },
              ]}
            >
        ...
        <View style={styles.card}>
          <View style={styles.evidenceHeader}>
            <Text style={styles.cardTitle}>Evidence ({evidenceImages.length})</Text>
              ...
              <View key={i} style={styles.evidenceItem}>
                ...
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={styles.evidenceMeta}>
                    {img.uploadedBy || 'Admin'} • {img.date || caseItem.createdAt}
                  </Text>
                </View>
              </View>
            ))
