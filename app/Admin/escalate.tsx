    ...
    const fetchOptions = async () => {
      try {
        const levelsSnap = await getDocs(
          collection(db, "escalation_levels")
        );
        setEscalationLevels(
        ...
        const reasonsSnap = await getDocs(
          collection(db, "escalation_reasons")
        );
        ...
        <View style={styles.noticeCard}>
          ...
          <View style={{ flex: 1, marginLeft: 10 }}>
            ...
            <Text style={styles.noticeText}>
              Escalated cases will be reviewed by higher authority and cannot
              be reversed.
            </Text>
          </View>
        </View>
