...
export default function ForgotPasswordScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <TextInput
        style={styles.input}
        placeholder={isAdmin ? 'Enter your Email or Admin ID' : 'Enter your Email or Consumer ID'}
      ...
      <View style={[styles.noticeBox, { backgroundColor: noticeBg, borderColor: noticeBdr }]}>
      ...
      <Text style={styles.supportText}>
        ...
        <Text style={[styles.supportLink, { color: accent }]}>1800-xxx-xxxx</Text>
      </Text>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  noticeBox:           { flexDirection: 'row', alignItems: 'flex-start', borderRadius: 8, borderWidth: 1, padding: 12, width: '100%', marginBottom: 28, gap: 10 },
  ...
  sendButton:          { width: '100%', borderRadius: 8, paddingVertical: 15, alignItems: 'center', marginBottom: 12 },
